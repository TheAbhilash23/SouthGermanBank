    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CustId', models.BigAutoField(primary_key=True, serialize=False, verbose_name='Id')),
                ('IsGoodCreditRisk', models.BooleanField(blank=True, null=True, verbose_name='Has the credit contract been complied with (good) or not (bad) ?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('HasBankAccount', models.BooleanField(blank=True, null=True, verbose_name='Has bank account with this bank')),
            ],
            options={
